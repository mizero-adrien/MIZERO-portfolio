...
export const ui = {
  ...
  fr: {
    ...
    skillsShowMore: 'Plus de competences',
    skillsShowLess: 'Afficher moins de competences',
  ...
  rw: {
    ...
    skillsShowMore: 'Andi bumenyi',
    skillsShowLess: 'Erekana buke',
